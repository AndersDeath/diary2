...
# 20 August 2022 - Saturday - Rzhev - Tver - Saint-Petersburg

We are going home today. We are sitting in a cafe in Tver. Ksushas mother and her husband drove us to Tver. The mother had an appointment in medical center. Then we separated and went to different sides. Me and Ksusha walked around Tvers city-center and then went to cafe that I mentioned before. We spet a lot of time there and them met again Ksushas mother and mother's husband. They invited us to Georgian restaraunt that was quite good. After that we went to huge mall GLobus that is in depressibve Tver's district. we walked there, got a cup of tea and bought some goods in train. After that they drove us to the central railway station. We sat to the train and now I am writing this lines there. Also I decied to restructure this diary. for the first time i downloaded it to the laptop and separated big file to smaller ones.

# 21 August 2022 - Sunday - Saint-Petersburg

I met Artyom Sagaida today. He is a front-end chapter lead in drsmile and back then he was my teamlead. He is a very professianal. We talked a bit about us and about job. honestly It was somthing like real getting to know. We were in British backery which is on Mayakovskaya metro station in the Saint-Petersburg city center. i am glad to see him. I hope we will meet each other in reallity in the future. Anywas I also sorted out the suitcases after our trip. Me and Ksusha met each other in the sity center and were in Beirut cafe which is nice place but unfortunately very expencieve. They changed prices because of war. It is sad, but ok. We walked a bit aroud and have a  nice time honestly. I would be happy to repeat this expierence again. 
...
Ive started this day from product training and english learning. I also fixed tooth. Prices for dental service increased a lot. it's not a surprise. Also I published knock from the future piece of news. I think it will be fun to publish this kind of stuff. I've started taken photos of goods that I want to sell on Avito. Patially i finished with it. I need a bit more time for it. Honestly I am very tiered again =) As usual i am complaning about it. by the way, I started investigation of the next brand new font-end topic. it simple terms i want to mage simple angular application with firebase auth inegration but on very deep level. there will be registration, changing password think etc. i want to use this stuff as parts of MVP solutions in the future. But sfS project is still my highest priority. after dinner we are going to the city center.

# 25 August 2022 - Thursday - Saint-Perersburg

Today I mostly was working on DRSMILE release. I spent a bit time on setting up Apple developer and distribution certificates. This is quite shitty process. Also I had a nice call with Artem, who is my coleege. In the evening i and Ksusha are going to walk in the city center. I think i will be nice. We are going to Obvodniy channel. After that I do not know what we will do. I also proceeded working on small angular+firebase+auth thing. I want to finish with it tomorrow and after that create a new project within DRSMILE. That is probably it for today.
...
I finally finished working on NG-FIREBASE-AUTH thing. I need to groom it, add some interfaces and fixes. I will do this tomorrow and after that I will start to separate the project by steps in order to put it into an article. Also There was also a strange situation with Marat. He received his feedback from other people and began to find out who did it and why. I do not like this guy. I am tiered of him. At the same time I did other things today. Partially it was a waste of time, but anyway I was productive person. Tomorrow KSusha will start 3d max lessons with personal teacher. It's very good. I hope she will start working as a designer soon and became more confident in life. I wish her all my best. After dinner we are going to Gulf of Finland. I think it will be cool =)
...
# 31 August - Wednesday - Saint-Petersburg

I did sports today. I did meditation. That's amaizing. I also trained English and Prodcut thinking today. Also the conflict between TJ team and Marat has been growing. i cannot understand whom i can belive in that situation. i am trying to do my best, but in reality it looks bad. I would be happy to change the situation, but honest feedback about Marat ruined his dreams about relocation to Berlin. I cannot say that it was a good thing, but I cannot change it. Unfortunately this guy is so unclear and hidden. he cannot understand that bullshit that he tryied to feed me doesn't work. i do not want to do anything with him anymore. Anyway it is a problem that i should to fix somehow. Unfortunately I didn't have time to resolve some ng-firebase-auth tasks. I was fully concentrated on DRSMILE. honestly i am very close to be burned out. I need a break. somethimes I feel that i cannot handle it. EU introduced some new rules for visas. Actually they just cancelled some easy ways to get tourist visa to europe. It ruined me, because i really need to get it. Anyway Today i am going to see mom. I am will her on the job in the library.

# 01 September - Thursday - Saint-Petersburg

The conflict with Marat has gone.
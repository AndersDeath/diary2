...
Сегодня была прямо очень хорошая погода. Даже тяжело было работать. Утром я сходил на спор а потом просто работал. Я программировали и настраивал всякие вещи. Вечером мы съездили в китайский хот-пот ресторанчик и поели.